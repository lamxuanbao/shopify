...
<div class="card-body msg_card_body" id="message_body">
        ...
        @if($message->from['id'] != $pageId)
            <div class="d-flex justify-content-start mb-4">
                ...
                @elseif($message->sticker != '')
                    <img src="{{$message->sticker}}" width="100" height="100">
                @else
                    @foreach($message->attachments as $attachment)
                        @if(isset($attachment['image_data']))
                            <img src="{{$attachment['image_data']['preview_url']}}" width="100" height="100">
                        @endif
                        @if(isset($attachment['video_data']))
...
<div class="card-footer">
    <div class="input-group">
        ...
        <textarea name="" class="form-control type_msg" id="message_reply"
